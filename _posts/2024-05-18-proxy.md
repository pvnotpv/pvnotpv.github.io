...
Call upgradeToAndCall() to the proxy contract with the new implementation and data, we can see that our contract has been upgraded and we can call bankName() to our proxy and it returns the name.

---

If you have a strong solid understanding of deledatecall function then implementing proxies is not that of a big deal.
